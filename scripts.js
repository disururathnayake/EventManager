        ...
        bookings.forEach((booking) => {
          const row = `
            <tr>
              ...
              <td>
                <button class="btn btn-primary btn-sm edit-booking" data-id="${
                  booking.bookingId
                }">Edit</button>
                <button class="btn btn-danger btn-sm delete-booking" data-id="${
                  booking.bookingId
                }">Delete</button>
              </td>
            </tr>`;
...
function loadReviews(eventId) {
  $.get(`/reviewevents/${eventId}`, function (reviews) {
    ...
    if (reviews.length > 0) {
        ...
        reviewsContainer.append(`
            <div class="card mb-3">
              <div class="card-body">
                ...
                <p class="text-muted">Reviewed on: ${new Date(
                  review.createdAt
      ...
      reviewsContainer.append(
        '<p class="text-muted">No reviews found for this event.</p>'
      );
    }
  }).fail(function () {
